...
void DiskManager::readDiskBlock(std::string partitionName, BlkNumType blknum, char *blkdata)
{
...
void DiskManager::writeDiskBlock(std::string partitionName, BlkNumType blknum, char *blkdata)
{
  /* find partition index in diskP */
  BlkNumType index = 0;
  index = findPart(partitionName)->partitionBlkStart;
...
BlkNumType DiskManager::getPartitionSize(std::string partitionName)
{
  BlkNumType size = 0;
...
DiskPartition* DiskManager::findPart(std::string partitionName)
{
