...
//[================================================================================================-->]
std::regex tag_files ("tag (/[0-9a-zA-Z_]*)*/[0-9a-zA-Z]+(\\.[a-zA-Z]+)? \\+> \\[([0-9a-zA-Z_]+)(,[0-9a-zA-Z_]+)*\\]");
std::regex add_tags ("tag \\[([0-9a-zA-Z_]+)(\\.[a-zA-Z]+)?(,([0-9a-zA-Z_]+)(\\.[0-9a-zA-Z_]+)?)*\\] \\+> \\[([0-9a-zA-Z_]+)(,[0-9a-zA-Z_]+)*\\]");
//[================================================================================================-->]
...
int check_command(std::string command)
{
    ...
    else if(std::regex_match(command,untag_file)){return 21;}
    else if(std::regex_match(command,untag_files)){return 22;}
    else if(std::regex_match(command,change_dir)){return 23;}
    else{return 0;}
}
//[================================================================================================]
