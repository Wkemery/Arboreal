...
void print_help()
{
    ...
    std::cout << "|                                                                                   |\n";
    std::cout << "|   X) { 'cd' './tag1/tag2' (Relative Path CD)                                      |\n";
    std::cout << "|                                                                                   |\n";
    std::cout << "|  24) { read '../tag1/filename(.ext) (-b # of bytes)                               |\n";
    std::cout << "|                                                                                   |\n";
    std::cout << "|  25) { read filename(.ext) (-b # of bytes)                                        |\n";
    std::cout << "|                                                                                   |\n";
    std::cout << "|  26) { write '../tag1/filename(.ext)                                              |\n";
    std::cout << "|                                                                                   |\n";
    std::cout << "|  27) { write filename(.ext)                                                       |\n";
    std::cout << "|                                                                                   |\n";
    std::cout << "|  28) { write -b X '../tag1/filename(.ext)' -> '../tag1/filename2(.ext)            |\n";
    std::cout << "|                                                                                   |\n";
    std::cout << "|  29) { write -b X 'filename(.ext) -> filename2(.ext)                              |\n";
    std::cout << "|                                                                                   |\n";
    std::cout << "|  30) { copy '../tag1/filename(.ext) -> '../tag1/filename2(.ext)                   |\n";
    std::cout << "|                                                                                   |\n";
    std::cout << "|  31) { copy 'filename(.ext) -> filename2(.ext)                                    |\n";
    std::cout << "|                                                                                   |\n";
    std::cout << "+-----------------------------------------------------------------------------------+\n";
    std::cout << "Arboreal >> ";
    return;
